  ...
  getJSON('https://hype-armor-crispy-waffle-rrx5v5rqqrfrr9-5000.preview.app.github.dev/api',
    function(err, data) {
      if (err !== null) {
        ...
        document.getElementById("now_temperature").innerHTML = data.weather.current_conditions.temperature;
        ...
        document.getElementById("1_temperature").innerHTML = data.forecast.conditions[0].temperature;
        ...
        document.getElementById("2_temperature").innerHTML = data.forecast.conditions[1].temperature;
